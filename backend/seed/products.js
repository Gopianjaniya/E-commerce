...
const products = [
    ...
    // ── MEN – Extra Topwear
    {
        ...
        image: [
            ...
            "https://images.unsplash.com/photo-1578681994506-b8f463449011?w=600&auto=format&fit=crop",
        ],
        sizes: ["S", "M", "L", "XL", "XXL"],
        date: Date.now(),
        bestseller: false,
    ...
    },
    {
        ...
        image: [
            ...
            "https://images.unsplash.com/photo-1556906781-9a412961a28c?w=600&auto=format&fit=crop",
        ],
        sizes: ["S", "M", "L", "XL"],
        date: Date.now(),
        bestseller: false,
    ...
    // ── MEN – Winterwear (winter-themed images)
    {
        ...
        subCategory: "Winterwear",
        image: [
            "https://images.unsplash.com/photo-1548883354-94bcfe321cbb?w=600&auto=format&fit=crop",
    ...
    },
    {
        ...
        subCategory: "Winterwear",
        image: [
            "https://images.unsplash.com/photo-1608234807905-4466023792f5?w=600&auto=format&fit=crop",
            "https://images.unsplash.com/photo-1520975922014-2f55e93aefba?w=600&auto=format&fit=crop",
        ],
        sizes: ["S", "M", "L", "XL"],
        date: Date.now(),
        bestseller: false,
    ...
    // ── MEN – Accessories
    {
        ...
        subCategory: "Accessories",
        image: [
            "https://images.unsplash.com/photo-1491637639811-60e2756cc1c7?w=600&auto=format&fit=crop",
            "https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=600&auto=format&fit=crop",
        ],
        sizes: ["Free Size"],
        date: Date.now(),
    ...
    // ── MEN – Footwear
    {
        ...
        subCategory: "Footwear",
        image: [
            "https://images.unsplash.com/photo-1510771463146-e89e6e86560e?w=600&auto=format&fit=crop",
            "https://images.unsplash.com/photo-1449505278894-297fdb3edbc1?w=600&auto=format&fit=crop",
        ],
        sizes: ["7", "8", "9", "10", "11"],
        date: Date.now(),
        bestseller: false,
    ...
    // ── WOMEN – Extra Topwear
    {
        ...
        subCategory: "Topwear",
        image: [
            "https://images.unsplash.com/photo-1548142813-c348350df52b?w=600&auto=format&fit=crop",
            "https://images.unsplash.com/photo-1552664688-cf412ec27db2?w=600&auto=format&fit=crop",
        ],
        sizes: ["XS", "S", "M", "L", "XL"],
        date: Date.now(),
        bestseller: true,
    ...
    },
    {
        ...
        image: [
            ...
            "https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=600&auto=format&fit=crop",
        ],
        sizes: ["XS", "S", "M", "L"],
        date: Date.now(),
        bestseller: false,
    ...
    },
    {
        ...
        subCategory: "Winterwear",
        image: [
            "https://images.unsplash.com/photo-1601924921557-45e6dea0a157?w=600&auto=format&fit=crop",
            "https://images.unsplash.com/photo-1512327536842-5aa37d1ba3e3?w=600&auto=format&fit=crop",
        ],
        sizes: ["XS", "S", "M", "L"],
        date: Date.now(),
        bestseller: false,
    ...
    // ── WOMEN – Ethnic
    {
        ...
        image: [
            "https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=600&auto=format&fit=crop",
            "https://images.unsplash.com/photo-1618085220035-5da19aca1884?w=600&auto=format&fit=crop",
        ],
        sizes: ["XS", "S", "M", "L", "XL"],
        date: Date.now(),
        bestseller: true,
    ...
    },
    {
        ...
        subCategory: "Winterwear",
        image: [
            "https://images.unsplash.com/photo-1583846783214-7229a91b20ed?w=600&auto=format&fit=crop",
            "https://images.unsplash.com/photo-1548883354-94bcfe321cbb?w=600&auto=format&fit=crop",
        ],
        sizes: ["S", "M", "L"],
        date: Date.now(),
